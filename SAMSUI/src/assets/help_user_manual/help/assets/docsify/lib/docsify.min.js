! function() {
    ...
    function s() {
        var e = d({
            ...
            t = a || [].slice.call(document.getElementsByTagName("script")).filter(function(e) {
        ...
        if (t)
            for (var n in e)
                if (l.call(e, n)) {
                    ...
                    c(r) && (e[n] = "" === r || r)
                } return !0 === e.loadSidebar && (e.loadSidebar = "_sidebar" + e.ext), !0 === e.loadNavbar && (e.loadNavbar = "_navbar" + e.ext), !0 === e.coverpage && (e.coverpage = "_coverpage" + e.ext), !0 === e.repo && (e.repo = ""), !0 === e.name && (e.name = ""), window.$docsify = e
    }
    var g = document.body.clientWidth <= 600,
        u = window.history && window.history.pushState && window.history.replaceState && !navigator.userAgent.match(/((iPod|iPhone|iPad).+\bOS\s+[1-4]\D|WebApps\/.+CFNetwork)/),
        n = {};
    ...
    function C(e) {
        ...
        }(), t = i ? 80 < (t = parseInt($.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100), $.style.opacity = 1, $.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(E), E = setTimeout(function(e) {
        ...
        return s.send(), {
            then: function(r, i) {
                if (void 0 === i && (i = h), e) {
                    ...
                    n("progress", C), n("loadend", function(e) {
                        C(e), clearInterval(t)
                    })
                }
    ...
    function z(e, t, r, n) {
        ...
        }), n && (p.title = a ? a.title || a.innerText + " - " + O : O), a
    }
    ...
    function q(e, t) {
        void 0 === t && (t = []);
        var n = [];
        for (var r in e) - 1 < t.indexOf(r) || n.push(e[r] ? (N(r) + "=" + N(e[r])).toLowerCase() : N(r));
    ...
    function W() {
        ...
        }(this, W), this.start = e.start, this.end = e.end, this.decimal = e.decimal
    }
    ...
    function X() {
        ...
        ! function(e, t) {
            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }(this, X), this.duration = e.duration || 1e3, this.ease = e.easing || this._defaultEase, this.tweener = e.tweener || new t(e), this.start = this.tweener.start, this.end = this.tweener.end, this.frame = null, this.next = null, this.isRunning = !1, this.events = {}, this.direction = this.start < this.end ? "up" : "down"
    }
    var Q = {},
        J = !1,
        K = null,
    ...
    function ne(e) {
        if (ee) {
            for (var t, n = m(".sidebar"), r = y(".anchor"), i = b(n, ".sidebar-nav"), a = b(n, "li.active"), s = document.documentElement, o = (s && s.scrollTop || document.body.scrollTop) - te, l = 0, c = r.length; l < c; l += 1) {
                var u = r[l];
                if (u.offsetTop > o) {
                    t = t || u;
                    break
            ...
            if (t) {
                ...
                if (h && h !== a && (a && a.classList.remove("active"), h.classList.add("active"), a = h, !J && v.classList.contains("sticky"))) {
    ...
    function ie(e, t) {
        if (t) {
            var n = s().topMargin,
                r = b("#" + t);
            r && function(e, t) {
                void 0 === t && (t = 0), K && K.stop(), ee = !1, K = new V({
    ...
    function se(e, t) {
        ...
        return e.forEach(function(e) {
            n += '<li><a class="section-link" href="' + e.slug + '">' + e.title + "</a></li>", e.children && (n += se(e.children, t))
        }), t.replace("{inner}", n)
    }
    ...
    function pe(e) {
        ...
        var t = e.trim().replace(/[A-Z]+/g, he).replace(/<[^>\d]+>/g, "").replace(ue, "").replace(/\s/g, "-").replace(/-+/g, "-").replace(/^(\d)/, "_$1"),
            n = ce[t];
    ...
    var ve, be = me(function(e) {
            ...
            var u = /\blang(?:uage)?-([\w-]+)\b/i,
                ...
                T = {
                    ...
                    highlightAllUnder: function(e, t, n) {
                        ...
                        for (var i, a = 0; i = r.elements[a++];) T.highlightElement(i, !0 === t, r.callback)
                    },
                    highlightElement: function(e, t, n) {
                        ...
                        function o(e) {
                            s.highlightedCode = e, T.hooks.run("before-insert", s), s.element.innerHTML = s.highlightedCode, T.hooks.run("after-highlight", s), T.hooks.run("complete", s), n && n.call(s.element)
                        }
                        if (T.hooks.run("before-sanity-check", s), !s.code) return T.hooks.run("complete", s), void(n && n.call(s.element));
                                    ...
                                    for (var v = r, b = i; v < t.length; b += t[v].length, ++v) {
                                        ...
                                        if (!(y instanceof R)) {
                                            if (d && v != t.length - 1) {
                                                ...
                                                for (var k = A.index + (p && A[1] ? A[1].length : 0), w = A.index + A[0].length, x = v, _ = b, S = t.length; x < S && (_ < w || !t[x].type && !t[x - 1].greedy); ++x)(_ += t[x].length) <= k && (++v, b = _);
                                            ...
                                            if (A) {
                                                ...
                                                if (F.push(L), C && F.push(C), Array.prototype.splice.apply(t, F), 1 != $ && T.matchGrammar(e, t, n, v, b, !0, o + "," + c), a) break
                                            } else if (a) break
                                        }
                                    }
                                }
        ...
        e.exports && (e.exports = c), void 0 !== fe && (fe.Prism = c), c.languages.markup = {
                comment: /<!--[\s\S]*?-->/,
                prolog: /<\?[\s\S]+?\?>/,
                doctype: {
    ...
    ve = Prism, Object.defineProperties(ve.languages["markup-templating"] = {}, {
        buildPlaceholders: {
            value: function(r, i, e, a) {
                if (r.language === i) {
                    ...
                    r.code = r.code.replace(e, function(e) {
                        ...
                        for (var t, n = s.length; - 1 !== r.code.indexOf(t = ye(i, n));) ++n;
                        return s[n] = e, t
                            ...
                            if ("string" == typeof r || r.content && "string" == typeof r.content) {
                                ...
                                if (-1 < l) {
                                    ...
                                    var c = s.substring(0, l),
                                        u = new ve.Token(g, ve.tokenize(a, d.grammar), "language-" + g, a),
    ...
    var ke = me(function(v, e) {
            ! function() {
                ...
                y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, y._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, y.def = e(y.def).replace("label", y._label).replace("title", y._title).getRegex(), y.bullet = /(?:[*+-]|\d{1,9}\.)/, y.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, y.item = e(y.item, "gm").replace(/bull/g, y.bullet).getRegex(), y.list = e(y.list).replace(/bull/g, y.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + y.def.source + ")").getRegex(), y._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", y._comment = /<!--(?!-?>)[\s\S]*?-->/, y.html = e(y.html, "i").replace("comment", y._comment).replace("tag", y._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), y.paragraph = e(y._paragraph).replace("hr", y.hr).replace("heading", " {0,3}#{1,6} +").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}|~{3,})[^`\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", y._tag).getRegex(), y.blockquote = e(y.blockquote).replace("paragraph", y.paragraph).getRegex(), y.normal = d({}, y), y.gfm = d({}, y.normal, {
                    ...
                    for (e = e.replace(/^ +$/gm, ""); e;)
                        ...
                        for (e = e.substring(i[0].length), l = {
                            ...
                            checked: v,
                            loose: r
                        }, c.push(u), this.tokens.push(u), this.token(o, !1), this.tokens.push({
                            type: "list_item_end"
                        });
                        if (l.loose)
                ...
                n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", n.em = e(n.em).replace(/punctuation/g, n._punctuation).getRegex(), n._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, n.autolink = e(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = e(n.tag).replace("comment", y._comment).replace("attribute", n._attribute).getRegex(), n._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, n._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = e(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(), n.reflink = e(n.reflink).replace("label", n._label).getRegex(), n.normal = d({}, n), n.pedantic = d({}, n.normal, {
                    ...
                    for (var t, n, r, i, a, s, o = ""; e;)
                        if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length), o += k(a[1]);
                    ...
                    } else if (a = this.rules.strong.exec(e)) e = e.substring(a[0].length), o += this.renderer.strong(this.output(a[4] || a[3] || a[2] || a[1]));
                    else if (a = this.rules.em.exec(e)) e = e.substring(a[0].length), o += this.renderer.em(this.output(a[6] || a[5] || a[4] || a[3] || a[2] || a[1]));
                    else if (a = this.rules.code.exec(e)) e = e.substring(a[0].length), o += this.renderer.codespan(k(a[2].trim(), !0));
                    ...
                    else if (a = this.rules.autolink.exec(e)) e = e.substring(a[0].length), r = "@" === a[2] ? "mailto:" + (n = k(this.mangle(a[1]))) : n = k(a[1]), o += this.renderer.link(r, null, n);
                    else if (this.inLink || !(a = this.rules.url.exec(e))) {
                        if (a = this.rules.text.exec(e)) e = e.substring(a[0].length), this.inRawBlock ? o += this.renderer.text(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]) : o += this.renderer.text(k(this.smartypants(a[0])));
                        else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                    } else {
                    ...
                    this.inline = new u(e.links, this.options), this.inlineText = new u(e.links, d({}, this.options, {
                        renderer: new i
                    ...
                    switch (this.token.type) {
                        ...
                        case "list_start":
                            a = "";
                            for (var s = this.token.ordered, o = this.token.start;
        ...
        _e = function(i, e) {
            ...
            var n = i.markdown || {};
            s = r(n) ? n(ke, t) : (ke.setOptions(d(n, {
                renderer: d(t, n.renderer)
            })), ke), this._marked = s, this.compile = function(n) {
                var r = !0,
                    e = o(function(e) {
                        r = !1;
                        var t = "";
                        return n ? (t = c(n) ? s(n) : s.parser(n), t = i.noEmoji ? t : function(e) {
                            ...
                            }).replace(/:(\w+?):/gi, window.emojify || de).replace(/__colon__/g, ":")
                        }(t), pe.clear(), t) : n
                    })(n),
    ...
    _e.prototype.compileEmbed = function(e, t) {
        ...
        if (t = i, a.include) {
            var s;
            if (H(e) || (e = D(this.contentBase, I(this.router.getCurrentPath()), e)), a.type && (s = xe[a.type]))(n = s.call(this, e, t)).type = a.type;
            else {
                var o = "code";
                /\.(md|markdown)/.test(e) ? o = "markdown" : /\.mmd/.test(e) ? o = "mermaid" : /\.html?/.test(e) ? o = "iframe" : /\.(mp4|ogg)/.test(e) ? o = "video" : /\.mp3/.test(e) && (o = "audio"), (n = xe[o].call(this, e, t)).type = o
            }
        ...
        var e = new ke.Renderer,
            ...
            c = this,
            r = {};
        return r.heading = e.heading = function(e, t) {
            var n = ge(e),
                r = n.str,
                i = n.config,
                a = {
            ...
            return e.renderer.code = function(e, t) {
                ...
                return '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + be.highlight(e.replace(/@DOCSIFY_QM@/g, "`"), n) + "</code></pre>"
            }
        }({
            renderer: e
        }), r.link = function(e) {
            ...
            return t.link = function(e, t, n) {
                ...
                var r = [],
                    ...
                    a = i.str,
                    s = i.config;
                return t = a, H(e) || c._matchNotCompileLink(e) || s.ignore ? (!H(e) && e.startsWith("./") && (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e), r.push(0 === e.indexOf("mailto:") ? "" : 'target="' + l + '"')) : (e === c.config.homepage && (e = "README"), e = o.toURL(e, null, o.getCurrentPath())), s.target && r.push('target="' + s.target + '"'), s.disabled && (r.push("disabled"), e = "javascript:void(0)"), s.class && r.push('class="' + s.class + '"'), s.id && r.push('id="' + s.id + '"'), t && r.push('title="' + t + '"'), '<a href="' + e + '" ' + r.join(" ") + ">" + n + "</a>"
            }
        }({
            renderer: e,
            router: l,
            ...
            return e.renderer.paragraph = function(e) {
                return /^!&gt;/.test(e) ? oe("tip", e) : /^\?&gt;/.test(e) ? oe("warn", e) : "<p>" + e + "</p>"
            }
        }({
            renderer: e
        }), r.image = function(e) {
            ...
            return t.image = function(e, t, n) {
                var r = e,
                    ...
                    s = a.str,
                    o = a.config;
                if (t = s, o["no-zoom"] && i.push("data-no-zoom"), t && i.push('title="' + t + '"'), o.size) {
                    var l = o.size.split("x"),
                        c = l[0],
                        u = l[1];
                    u ? i.push('width="' + c + '" height="' + u + '"') : i.push('width="' + c + '" height="' + c + '"')
                }
                return o.class && i.push('class="' + o.class + '"'), o.id && i.push('id="' + o.id + '"'), H(e) || (r = D(h, I(p.getCurrentPath()), e)), 0 < i.length ? '<img src="' + r + '" data-origin="' + e + '" alt="' + n + '" ' + i.join(" ") + " />" : '<img src="' + r + '" data-origin="' + e + '" alt="' + n + '"' + i + ">"
            }
        }({
            renderer: e,
            contentBase: n,
    ...
    function Le(e, t, n) {
        return t = "function" == typeof n ? n(t) : "string" == typeof n ? function(r, i) {
            var a = [],
                s = 0;
            return r.replace(Ee, function(t, e, n) {
                    a.push(r.substring(s, n - 1)), s = n += t.length + 1, a.push(i && i[t] || function(e) {
                        return ("00" + ("string" == typeof Ce[t] ? e[Ce[t]]() : Ce[t](e))).slice(-t.length)
                    })
    ...
    function Te(e) {
        e = e || "<h1>404 - Not found</h1>", this._renderTo(".markdown-section", e), this.config.loadSidebar || this._renderSidebar(), !1 === this.config.executeScript || void 0 === window.Vue || Fe() ? this.config.executeScript && Fe() : setTimeout(function(e) {
    ...
    function Re(e) {
        var t = e.config;
        e.compiler = new _e(t, e.router), window.__current_docsify_compiler__ = e.compiler;
        var n = t.el || "#app",
            r = b("nav") || k("nav"),
            i = b(n),
            a = "",
        ...
        t.mergeNavbar && g ? s = b(".sidebar") : (r.classList.add("app-nav"), t.repo || r.classList.add("no-badge")), t.loadNavbar && x(s, r), t.themeColor && (p.head.appendChild(k("div", function(e) {
    ...
    Pe.prototype.getBasePath = function() {
        ...
        return e = (e = function(e, t) {
            ...
            var i = Object.keys(n).filter(function(e) {
                return (Oe[e] || (Oe[e] = new RegExp("^" + e + "$"))).test(t) && t !== r
            })[0];
            return i ? e(t.replace(Oe[i], n[i]), n, t) : t
        }(e, n.alias) : e, i)) === "/README" + i && n.homepage || e, e = H(e) ? e : D(r, e), t && (e = e.replace(new RegExp("^" + r), "")), e
    }, Pe.prototype.onchange = function(e) {
        void 0 === e && (e = h), e()
    }, Pe.prototype.getCurrentPath = function() {}, Pe.prototype.normalize = function() {}, Pe.prototype.parse = function() {}, Pe.prototype.toURL = function(e, t, n) {
        var r = n && "#" === e[0],
            i = this.parse(U(e));
        if (i.query = d({}, i.query, t), e = (e = i.path + q(i.query)).replace(/\.md(\?)|\.md$/, "$1"), r) {
            var a = n.indexOf("?");
    ...
    function He(e) {
        ...
        }(".sidebar", e.router), e.config.coverpage ? g || _("scroll", P) : v.classList.add("sticky")
    }

    function Ie(t, n, r, i, a, e) {
        t = e ? t : t.replace(/\/$/, ""), (t = I(t)) && L(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i, function(e) {
            return Ie(t, n, r, i, a)
        })
    }
    ...
    We._init = function() {
            ...
            e.config = s(),
                ...
                function(t) {
                    var e, n = t.config;
                    e = "history" === (n.routerMode || "hash") && u ? new Ne(n) : new je(n), t.router = e, qe(t), Me = t.route, e.onchange(function(e) {
                        qe(t), t._updateRender(), Me.path !== t.route.path ? (t.$fetch(h, t.$resetEvents.bind(t, e.source)), Me = t.route) : t.$resetEvents(e.source)
                    })
                }(e), Re(e), He(e),
                function(t) {
                    ...
                    if (t.rendered) {
                        ...
                        e && n && (n.parentNode.innerHTML += window.__SUB_SIDEBAR__), t._bindEventOnRendered(n), t.$resetEvents(), R(t, "doneEach"), R(t, "ready")
                    } else t.$fetch(function(e) {
                        return R(t, "ready")
                    })
                }(e), R(e, "mounted")
        }, We.route = {}, (De = We)._renderTo = function(e, t, n) {
            var r = m(e);
            ...
            if (function(e) {
                ...
                var n = m("#main"),
                    r = n.children[0];
                r && "H1" !== r.tagName && x(n, k("div", this.compiler.header(e.innerText, 1)).children[0])
            }
        }, De._renderNav = function(e) {
            e && this._renderTo("nav", this.compiler.compile(e)), this.config.loadNavbar && z(this.router, "nav")
        }, De._renderMain = function(r, i, a) {
            var s = this;
            if (void 0 === i && (i = {}), !r) return Te.call(this, r);
            R(this, "beforeEach", r, function(e) {
                function t() {
                    i.updatedAt && (n = Le(n, i.updatedAt, s.config.formatUpdated)), R(s, "afterEach", n, function(e) {
                        return Te.call(s, e)
                    })
                }
                var n;
            ...
            if (A(m("main"), t ? "add" : "remove", "hidden"), e) {
                ...
                if (i) {
                    if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
                        ...
                        var a = i[1];
                        A(n, "add", "has-mask"), H(i[1]) || (a = D(this.router.getBasePath(), i[1])), n.style.backgroundImage = "url(" + a + ")", n.style.backgroundSize = "cover", n.style.backgroundPosition = "center center"
                    }
                    r = r.replace(i[0], "")
                }
            ...
            if (n) {
                ...
                return s ? (s = this.router.getFile(a + s), this.coverIsHTML = /\.html$/g.test(s), L(s + q(i, ["id"]), !1, r).then(function(e) {
            ...
            void 0 === e && (e = h), void 0 === t && (t = this.$resetEvents.bind(this)), this._fetchCover() ? r() : this._fetch(function() {
                t(), r()
            })
            ...
            return Ge(c + r, 0, t).then(function(e, t) {
            ...
            if (o) {
                ...
                return Ge(this.router.getFile(c), 0, s).then(function(e, t) {
            ...
            "history" !== e && (t.route.query.id && ie(t.route.path, t.route.query.id), "navigate" === e && n && function(e) {
                void 0 === e && (e = 0), ae.scrollTop = !0 === e ? 0 : Number(e)
            }(n)), this.config.loadNavbar && z(this.router, "nav")
        }, window.Docsify = {
            util: Be,
            dom: e,
            get: L,
            slugify: pe,
            version: "4.11.3"
        }, window.DocsifyCompiler = _e, window.marked = ke, window.Prism = be,
        function(e) {
