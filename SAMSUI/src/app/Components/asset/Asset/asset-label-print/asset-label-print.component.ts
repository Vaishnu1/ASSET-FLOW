...
@Component({
  ...
  templateUrl: './asset-label-print.component.html',
  styleUrls: ['./asset-label-print.component.css']
})
export class AssetLabelPrintComponent implements OnInit {
  ...
  constructor( private readonly dialogRef: MatDialogRef<AssetLabelPrintComponent>,
