...
@Component({
  selector: 'app-sr-with-pr-count',
  templateUrl: './sr-with-pr-count.component.html',
  styleUrls: ['./sr-with-pr-count.component.css']
})
export class SrWithPrCountComponent implements OnInit {
  ...
  getList(searchParams) {
    this.commonService.commonListService(this.samsService.listOfWorkorderWithPR, searchParams).subscribe(
      data => {
        if (data.success) {        
