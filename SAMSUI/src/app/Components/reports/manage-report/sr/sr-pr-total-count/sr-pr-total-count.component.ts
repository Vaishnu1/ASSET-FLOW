...
@Component({
  selector: 'app-sr-pr-total-count',
  templateUrl: './sr-pr-total-count.component.html',
  styleUrls: ['./sr-pr-total-count.component.css']
})
export class SrPrTotalCountComponent implements OnInit {
  dataSource1:any=[];               
 
  displayedColumns1:string[] = ['sno', 'locationName', 'srNo', 'srStatus', 'createdDtDisp', 'updatedDtDisp', 'woPrDaysDisp', 'assetCode', 'departmentName'];
  ...
  exportToexcel() {      
    ...
    this.commonService.commonListService(this.samsService.exportOpenWO,  this.searchParams.value).subscribe(
      (data) => {
