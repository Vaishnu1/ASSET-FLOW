...
@Component({
  selector: 'app-service-request-list-pa',
  templateUrl: './service-request-list-pa.component.html',
  styleUrls: ['./service-request-list-pa.component.css']
})
export class ServiceRequestListPaComponent implements OnInit,OnDestroy {

  //set page title
  title = 'Asset Optima - Performance Assurance Service Request';
  ...
  ngOnInit() {
    ...
    this.fetchList();
    //this.moduleAccessModel=this.userSessionService.getUserGroupAccess()['PERFORMANCE ASSURANCE'];
  }
  ...
  fetchList(){
    ...
    this.serviceRequestModel.srType='PA';
    this.dataSource = [];
    this.subloader = true;
