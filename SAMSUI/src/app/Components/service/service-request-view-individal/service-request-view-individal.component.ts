...
@Component({
  selector: 'app-service-request-view-individal',
  templateUrl: './service-request-view-individal.component.html',
  styleUrls: ['./service-request-view-individal.component.css']
})
export class ServiceRequestViewIndividalComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.srBreakDownGeneralForm = new FormGroup({
      ...
      assetActualInstalledDtDisp: new FormControl(''),
        ...
        if(this.screen !== "" && !this.previousPath){
         ...
         this.commonService.commonGetService('getServiceRequestById.sams', primaryId).subscribe(
            data => {  
              ...
              this.srBreakDownGeneralForm.controls.supplierName.setValue(data.responseData.assetHdrTO.supplierName);
              this.srBreakDownGeneralForm.controls.supplierContactPerson.setValue(data.responseData.assetHdrTO.supplContactPersonName);
              this.srBreakDownGeneralForm.controls.supplierContactNo.setValue(data.responseData.assetHdrTO.supplSiteContactNo);
              ...
              //SR CREATED IMAGES FROM MOBILE APP              
    ...
    this.commonService.commonGetService('fetchListOfSrActivityForSrId.sams', srId).subscribe(
      data => {
        ...
        for (let i = 0; i < data.responseData.length; i++) {
          ...
          console.log("data.responseData[i].endDtndTimeDisp : ",data.responseData[i].endDtndTimeDisp)
    ...
    if(this.srBreakDownGeneralForm.controls.physicalDamageDisp.value == 'YES' || this.srBreakDownGeneralForm.controls.physicalDamageDisp.value == 'NO') {
      ...
      dialogRef.afterClosed().subscribe(
        data => {
          ...
          if(data){
            this.router.navigate(['home/serviceRequest/serviceView/'+ this.srBreakDownGeneralForm.controls.srId.value +'/edit/sr_item_request/']);
            this.srItemRequest()
          }
