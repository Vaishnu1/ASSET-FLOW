...
@RestController
@RequestMapping("/api/v1/work-flow-conditions")
@RequiredArgsConstructor
public class WorkFlowConditionController {

    private final WorkFlowConditionService service;
    ...
    public ResponseEntity<String> delete(@PathVariable Long id) {
        service.delete(id);
        return ResponseEntity.ok("WorkFlowCondition deleted successfully!.");
    }
}