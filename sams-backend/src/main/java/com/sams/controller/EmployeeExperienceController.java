...
@RestController
@RequestMapping("/api/v1/m-employee-experiences")
...
public class EmployeeExperienceController {
    ...
    @GetMapping
    public ResponseEntity<List<EmployeeExperienceDTO>> getAll() {
    ...
    public ResponseEntity<String> delete(@PathVariable Long id) {
        service.delete(id);
        return ResponseEntity.ok("EmployeeExperience deleted successfully!.");
    }
}