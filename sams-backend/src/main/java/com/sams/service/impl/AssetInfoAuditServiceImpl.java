...
import com.sams.repository.AssetInfoAuditRepository;
...
public class AssetInfoAuditServiceImpl implements AssetInfoAuditService {

    private final AssetInfoAuditRepository repository;

    @Override
    @Transactional
    public AssetInfoAuditDTO create(AssetInfoAuditDTO dto) {
        AssetInfoAudit entity = mapToEntity(dto);
        return mapToDTO(repository.save(entity));
    }

    @Override
    public AssetInfoAuditDTO getById(Long id) {
        AssetInfoAudit entity = repository.findById(id).orElseThrow(() -> new ResourceNotFoundException("AssetInfoAudit not found with ID: " + id));
        return mapToDTO(entity);
    }

    @Override
    public List<AssetInfoAuditDTO> getAll() {
        return repository.findAll().stream().map(this::mapToDTO).collect(Collectors.toList());
    }

    @Override
    @Transactional
    public AssetInfoAuditDTO update(Long id, AssetInfoAuditDTO dto) {
        AssetInfoAudit entity = repository.findById(id).orElseThrow(() -> new ResourceNotFoundException("AssetInfoAudit not found with ID: " + id));
        AssetInfoAudit mapped = mapToEntity(dto);
    ...
    private AssetInfoAudit mapToEntity(AssetInfoAuditDTO dto) {
        AssetInfoAudit entity = new AssetInfoAudit();
    ...
    private AssetInfoAuditDTO mapToDTO(AssetInfoAudit entity) {
        AssetInfoAuditDTO dto = new AssetInfoAuditDTO();
