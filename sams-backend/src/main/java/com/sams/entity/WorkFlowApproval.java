...
@Entity
@Table(name = "work_flow_approval", schema = "workflow")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class WorkFlowApproval {
    ...
    @Column(name = "work_flow_approval_id")
    ...
    @Column(name = "employee_1_read_flag")
    private Boolean employee1ReadFlag;

    @Column(name = "employee_2_read_flag")
    private Boolean employee2ReadFlag;

    @Column(name = "employee_3_read_flag")
    private Boolean employee3ReadFlag;

    @Column(name = "approval_superceded_by")
    private Long approvalSupercededBy;

    @Column(name = "approval_superceded_date")
